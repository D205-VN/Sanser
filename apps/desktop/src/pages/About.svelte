...
<section class="page about-page">
  ...
  <div class="notice">Sanser is honest about capability state: unavailable or planned functions remain disabled until their native implementation is installed and verified.</div>
</section>
